...
# ─────────────────────────────────────────────────────────────────────────────
univariado_num      <- readRDS("light_data/univariado_num.rds")
univariado_cat      <- readRDS("light_data/univariado_cat.rds")
bivariado_num_stats <- readRDS("light_data/bivariado_num_stats.rds")
bivariado_cat       <- readRDS("light_data/bivariado_cat.rds")

# ─────────────────────────────────────────────────────────────────────────────
# Prevalências por agrupamento regional
# ─────────────────────────────────────────────────────────────────────────────
prevalencia_municipal    <- read_fst("light_data/municipal.fst")
prevalencia_regional     <- read_fst("light_data/regional.fst")
prevalencia_mesoregional <- read_fst("light_data/mesoregional.fst")
prevalencia_macroregional <- read_fst("light_data/macroregional.fst")
